    ...
    const proto::GeoGrid_Location_ContactCenter& protoContactCenter)
{
        ...
        Id typeId;
        switch (type) {
        case proto::GeoGrid_Location_ContactCenter_Type_Daycare: typeId = Id::Daycare; break;
        case proto::GeoGrid_Location_ContactCenter_Type_PreSchool: typeId = Id::PreSchool; break;
