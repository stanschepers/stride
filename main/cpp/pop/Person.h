...
public:
        ...
        Person(unsigned int id, double age, unsigned int householdId, unsigned int daycareId, unsigned int preSchoolId,
            ...
            : m_age(age), m_gender('M'), m_health(), m_id(id),
              m_is_participant(false), m_pool_ids{householdId, daycareId, preSchoolId, k12SchoolId, collegeId,
